...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        self.recent_tweet_text_label.grid(column=0, row=0, columnspan=3, sticky='EW')
        self.recent_tweet_text.set("Most recent tweet will go here")
        ...
        self.recent_tweet_time_label = Tkinter.Label(self, textvariable=self.recent_tweet_time,
                                  ...
                                  justify='left', relief='groove',
                                  cursor='dot', font=("Times",20))
        self.recent_tweet_time_label.grid(column=3, row=0, columnspan=3, sticky='EW')
        self.recent_tweet_time.set("Time will go here")
...
###########################################################################
        ...
        for i in range (0, self.label_amount):
            ...
            self.b.grid(column=2, row=i+1, columnspan=1, sticky='EW')  #Maybe will store which button was pressed?
...
###########################################################################
        ...
        for i in range (0,self.label_amount):
            ...
            station = Tkinter.Label(self, textvariable=self.text_variable_list[i+self.label_amount][0],
                                  ...
                                  justify='left', relief='groove',
                                  cursor='dot', font=("Times",20))
            station.grid(column=3, row=i+1, columnspan=1, sticky='EW')
        ...
        for i in range (0,self.label_amount):
            ...
            station = Tkinter.Label(self, textvariable=self.text_variable_list[i+self.label_amount][2],
                                  ...
                                  justify='left', relief='groove',
                                  cursor='dot', font=("Times",20))
            station.grid(column=4, row=i+1, columnspan=1, sticky='EW')
        ...
        for i in range (0, self.label_amount):
            ...
            self.b.config(command= lambda position=i+self.label_amount: self.on_button_click(position))  #added i+1 argument to on_button_click. 
            self.b.grid(column=5, row=i+1, columnspan=1, sticky='EW')  #Maybe will store which button was pressed?
#############################################################################################
    ...
    def file_load(self):
        SAVE_BUFFER = []
        f = open('/home/pi/Desktop/pydora-test/STATION_SAVE', 'r')
        station_list = f.read()
        f.close
    ...
    def delete_station(self,del_station):
        ...
        string = ''
        d = open("/home/pi/Desktop/pydora-test/STATION_SAVE", "r")
        s = d.read()
        d.close()
        ...
        for line in lines:
            if len(line) > 1:
                if str(line) != str(del_station):
                    string = string +'~' + line
        string = string + '~'
        d = open("/home/pi/Desktop/pydora-test/STATION_SAVE", "w")
        d.write(string)
        d.close
...
def twitter():
    ...
    class StdOutListener(tweepy.StreamListener):
        def on_data(self,data):
            ...
            lst = body.split('#ngtbtest')  #gets rid of the hashtag
    ...
    #estalishes streaming connection with twitter
